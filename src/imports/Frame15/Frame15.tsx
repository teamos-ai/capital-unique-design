import svgPaths from "./svg-2uuugl34ax";
import imgCompanyLogo from "./adadad985495d47cf71d8987c95a80328e7662a4.png";
import imgPlaceholderImage8 from "./442551f489cbe18c22b4b72b40a8cf65d48a3313.png";
import imgPlaceholderImage7 from "./32ddc3c3d213644acd504053786c5dbe067e800a.png";
import imgPlaceholderImage6 from "./eee390b7d92b3838c7427225b8a61dda6850373b.png";
import imgPlaceholderImage5 from "./cdc0733dec491e1e34d1830353e514529c497827.png";
import imgPlaceholderImage4 from "./bf4c477adeab8ed65505097334af4769f5ace180.png";
import imgPlaceholderImage3 from "./e39ad09ee2da7ea037f595732d58f87266edd730.png";
import imgPlaceholderImage2 from "./c5e1da60c0fbbc9693b6677dfc155f111d4c616a.png";
import imgPlaceholderImage1 from "./5b6d6f661de57a09f22fb7a3c4f6be53a293868c.png";
import imgCard from "./1dbff3b8e5affc3bd977ef8cfe9f21289431df0c.png";
import imgCard1 from "./2703a99350c6bf676ddb154a9ef234586180f8cd.png";
import imgPlaceholderImage from "./2ea58b8e83c531c0b60a2734c6479da05734e37a.png";
import imgPlaceholderImage9 from "./6c8343e364cd7b5741829ff6ed8b8272b80fbcef.png";
import imgPlaceholderImage10 from "./2b5b637c438d8d07227d96eb947e6e30055f6b0d.png";
...
function Content1() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 text-center text-white w-full" data-name="Content">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[1.1] relative shrink-0 text-[84px] tracking-[0.84px] w-full">Capital, without the constraints of banks.</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[20px] w-full">
        <p className="leading-[1.6] mb-0">Capital Unique operates where traditional lending ends.</p>
        <p className="leading-[1.6]">We connect borrowers seeking flexible finance with investors looking to deploy capital intelligently—quietly, clearly, and with intent.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Actions">
      ...
      <div className="content-stretch flex items-center justify-center px-[24px] py-[10px] relative rounded-[6px] shrink-0" data-name="Button">
        ...
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.6] not-italic relative shrink-0 text-[18px] text-white whitespace-nowrap">Fund</p>
      </div>
    </div>
  );
}
...
function ImageContainer() {
  return (
    <div className="-translate-y-1/2 absolute h-[900px] left-[-8.29%] overflow-clip right-[-6.82%] top-1/2" data-name="Image container">
      <div className="-translate-y-1/2 absolute aspect-[260/260] left-[82.73%] right-[1.58%] rounded-[8px] top-[calc(50%+365px)]" data-name="Placeholder Image 8">
      ...
      <div className="-translate-y-1/2 absolute aspect-[173/115] left-[57.58%] right-[31.99%] rounded-[8px] top-[calc(50%+347.5px)]" data-name="Placeholder Image 7">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgPlaceholderImage7} />
      </div>
      <div className="-translate-y-1/2 absolute aspect-[260/260] left-[24.58%] right-[59.74%] rounded-[8px] top-[calc(50%+410px)]" data-name="Placeholder Image 6">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgPlaceholderImage6} />
      </div>
      <div className="-translate-y-1/2 absolute aspect-[216/144] left-[85.39%] right-[1.58%] rounded-[8px] top-[calc(50%-153px)]" data-name="Placeholder Image 5">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgPlaceholderImage5} />
      </div>
      <div className="-translate-y-1/2 absolute aspect-[230/230] left-[62.83%] right-[23.3%] rounded-[8px] top-[calc(50%-425px)]" data-name="Placeholder Image 4">
      ...
      <div className="-translate-y-1/2 absolute aspect-[173/173] left-[41.95%] right-[47.61%] rounded-[8px] top-[calc(50%-318.5px)]" data-name="Placeholder Image 3">
      ...
      <div className="-translate-y-1/2 absolute aspect-[260/173] left-[15.89%] right-[68.42%] rounded-[8px] top-[calc(50%-453.5px)]" data-name="Placeholder Image 2">
      ...
      <div className="-translate-y-1/2 absolute aspect-[260/260] left-[0.26%] right-[84.05%] rounded-[8px] top-1/2" data-name="Placeholder Image 1">
...
function Header() {
  return (
    <div className="bg-[#1b1b1e] h-[900px] relative shrink-0 w-full" data-name="Header / 142 /">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[80px] items-center justify-center px-[64px] py-[112px] relative size-full">
          <Container1 />
          <ImageContainer />
        </div>
      </div>
...
function TaglineWrapper() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Tagline Wrapper">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.5] not-italic relative shrink-0 text-[#020205] text-[16px] text-center whitespace-nowrap">Dual purpose</p>
    </div>
  );
}
...
function Content4() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 text-[#020205] text-center w-full" data-name="Content">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[1.2] relative shrink-0 text-[60px] tracking-[0.6px] w-full">Two pathways. One disciplined approach.</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.6] not-italic relative shrink-0 text-[20px] w-full">Capital Unique exists at the intersection of borrowers seeking flexible finance and investors seeking structured opportunities. We bridge the gap traditional banking leaves behind.</p>
    </div>
  );
}
...
function TaglineWrapper1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Tagline Wrapper">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.5] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">For borrowers</p>
    </div>
  );
}
...
function ContentTop() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Content Top">
      <TaglineWrapper1 />
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[1.2] min-w-full relative shrink-0 text-[48px] text-white tracking-[0.48px] w-[min-content]">Strategic capital for complex decisions</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Actions">
      <div className="content-stretch flex gap-[8px] items-center justify-center overflow-clip relative rounded-[6px] shrink-0" data-name="Button">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.6] not-italic relative shrink-0 text-[#020205] text-[18px] whitespace-nowrap">Borrow Funds</p>
...
function ContentBottom() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full" data-name="Content Bottom">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.6] not-italic relative shrink-0 text-[18px] text-white w-full">We work with businesses, developers, and investors who need funding structured around real-world objectives—not standardised lending models.</p>
      <Actions1 />
    </div>
  );
}
...
function Card() {
  return (
    <div className="flex-[1_0_0] h-[630px] min-w-px relative" data-name="Card">
...
function TaglineWrapper2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Tagline Wrapper">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.5] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">For investors</p>
    </div>
  );
}
...
function ContentTop1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Content Top">
      <TaglineWrapper2 />
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[1.2] min-w-full relative shrink-0 text-[48px] text-white tracking-[0.48px] w-[min-content]">Deploy capital with structure and control</p>
    </div>
  );
}
...
function Actions2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Actions">
      <div className="content-stretch flex gap-[8px] items-center justify-center overflow-clip relative rounded-[6px] shrink-0" data-name="Button">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.6] not-italic relative shrink-0 text-[#020205] text-[18px] whitespace-nowrap">Provide Funds</p>
        <div className="overflow-clip relative shrink-0 size-[24px]" data-name="chevron_right">
          <div className="absolute inset-[25.72%_36.66%_25.88%_35.46%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.69159 11.6166">
              <path d={svgPaths.p36daa800} fill="var(--fill-0, white)" id="Vector" stroke="var(--stroke-0, white)" />
...
function ContentBottom1() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full" data-name="Content Bottom">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.6] not-italic relative shrink-0 text-[18px] text-white w-full">Capital Unique works with private investors and family offices seeking governed opportunities with clear terms, defined risk, and long-term alignment.</p>
      <Actions2 />
    </div>
  );
}
  ...
  return (
    <div className="flex-[1_0_0] h-[630px] min-w-px relative" data-name="Card">
      <div className="flex flex-col justify-end overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-start justify-end p-[48px] relative size-full">
          <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
            <img alt="" className="absolute max-w-none object-cover size-full" src={imgCard1} />
            <div className="absolute bg-[rgba(0,0,0,0.4)] inset-0" />
          </div>
          <ContentTop1 />
          <ContentBottom1 />
...
function Layout3() {
  return (
    <div className="bg-[#f2f2f2] relative shrink-0 w-full" data-name="Layout / 422 /">
...
function TaglineWrapper3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Tagline Wrapper">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.5] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">Borrow</p>
    </div>
  );
}
...
function Content8() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 text-white w-full" data-name="Content">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[1.2] relative shrink-0 text-[60px] tracking-[0.6px] w-full">Capital designed around your strategy</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[20px] w-full">
        <p className="leading-[1.6] mb-0">Development deals, acquisitions, and complex strategies require more than standard lending models.</p>
        <p className="leading-[1.6]">We structure capital around your objectives, timelines, and risk profile—so decisions move forward with clarity.</p>
      </div>
    </div>
  );
}
...
function ListItem() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="List Item">
      <div className="relative shrink-0 size-[16px]" data-name="speed">
        <div className="absolute inset-[16.12%_8.19%_16.04%_7.71%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.4566 10.8533">
            <path d={svgPaths.p2d580200} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.6] min-w-px not-italic relative text-[18px] text-white">Speed without compromise</p>
    </div>
  );
}
...
function ListItem1() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="List Item">
      <div className="relative shrink-0 size-[16px]" data-name="clarify">
        <div className="absolute inset-[11.85%_6.85%_11.88%_6.88%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.8033 12.2033">
            <path d={svgPaths.p1240ec80} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.6] min-w-px not-italic relative text-[18px] text-white">Clarity on real terms</p>
    </div>
  );
}
...
function ListItem2() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="List Item">
      <div className="relative shrink-0 size-[16px]" data-name="finance">
        <div className="absolute inset-[11.93%_11.63%_11.65%_11.65%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.275 12.2272">
            <path d={svgPaths.p32730a00} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.6] min-w-px not-italic relative text-[18px] text-white">Finance built around your deal</p>
    </div>
  );
}
...
function List() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start py-[8px] relative shrink-0 w-full" data-name="List">
      <ListItem />
      <ListItem1 />
      <ListItem2 />
    </div>
...
function Component() {
  return (
    <div className="content-stretch flex gap-[80px] items-center relative shrink-0 w-full" data-name="Component">
      <Content6 />
      <div className="aspect-[600/450] flex-[1_0_0] min-w-px relative rounded-[8px]" data-name="Placeholder Image">
...
function Layout() {
  return (
    <div className="bg-[#1b1b1e] relative shrink-0 w-full" data-name="Layout / 16 /">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center px-[64px] py-[112px] relative size-full">
          <Container4 />
        </div>
...
function TaglineWrapper4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Tagline Wrapper">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.5] not-italic relative shrink-0 text-[#020205] text-[16px] whitespace-nowrap">Fund</p>
    </div>
  );
}
...
function Content11() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 text-[#020205] w-full" data-name="Content">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[1.2] relative shrink-0 text-[60px] tracking-[0.6px] w-full">Structured opportunities for serious investors</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.6] not-italic relative shrink-0 text-[20px] w-full">Private capital deserves governance that matches its sophistication. We offer transparent structures, managed risk, and partnerships built to last.</p>
    </div>
  );
}
...
function ListItem3() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="List Item">
      <div className="relative shrink-0 size-[24px]" data-name="clear_day">
        <div className="absolute inset-[3.59%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.275 22.275">
            <path d={svgPaths.p34f1dec0} fill="var(--fill-0, #020205)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.6] min-w-px not-italic relative text-[#020205] text-[18px]">Transparent deal structures</p>
    </div>
  );
}
...
function ListItem4() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="List Item">
      <div className="relative shrink-0 size-[24px]" data-name="airware">
        <div className="absolute inset-[15.3%_16.35%_15.3%_16.4%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.1416 16.6575">
            <path d={svgPaths.p3cdb3600} fill="var(--fill-0, #020205)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.6] min-w-px not-italic relative text-[#020205] text-[18px]">Risk-aware partnerships</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="List Item">
      <div className="relative shrink-0 size-[24px]" data-name="route">
        <div className="absolute inset-[12.08%_11.48%_12.08%_11.5%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.4843 18.2035">
            <path d={svgPaths.p19cf1100} fill="var(--fill-0, #020205)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.6] min-w-px not-italic relative text-[#020205] text-[18px]">Long-term capital alignment</p>
    </div>
  );
}
...
function Component1() {
  return (
    <div className="content-stretch flex gap-[80px] items-center relative shrink-0 w-full" data-name="Component">
      <div className="aspect-[600/640] flex-[1_0_0] min-w-px relative rounded-[8px]" data-name="Placeholder Image">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgPlaceholderImage9} />
      </div>
      <Content9 />
    </div>
  );
...
function Layout1() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Layout / 207 /">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center px-[64px] py-[112px] relative size-full">
          <Container5 />
        </div>
...
function Column3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Column">
      <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[1.2] relative shrink-0 text-[60px] text-white tracking-[0.6px] w-full">Choose your path forward</p>
    </div>
  );
}
...
function Column4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[32px] items-start min-w-px relative" data-name="Column">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.6] min-w-full not-italic relative shrink-0 text-[20px] text-white w-[min-content]">{`Whether you need capital or seek investment opportunities, we're here to listen and advise.`}</p>
      <Actions6 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[80px] items-start max-w-[1280px] relative shrink-0 w-full" data-name="Container">
      ...
      <div className="aspect-[1280/738] relative rounded-[8px] shrink-0 w-full" data-name="Placeholder Image">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgPlaceholderImage10} />
      </div>
    </div>
  );
}
...
function GetCapitalDesktop() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 overflow-clip top-0 w-[1440px]" data-name="Get Capital • Desktop">
      <Navbar />
      <Header />
      <Logo />
      <Layout3 />
