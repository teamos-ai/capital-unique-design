...
export const libraryImages: LibraryImage[] = [
  ...
  { src: 'abstract/coffee-cup-icon-001.png', alt: 'A 3D-rendered black coffee cup with three gold steam wisps curling above, on a circular black saucer; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/coffee-cup-icon-002.png', alt: 'Black coffee cup variant — gold handle right-side, three gold steam wisps; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/coffee-cup-icon-003.png', alt: 'Black coffee cup variant — gold handle left-side, three gold steam wisps; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/house-icon-001.png', alt: 'A 3D-rendered black house with gold door, gold chimney detail; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/house-icon-002.png', alt: 'House icon variant — gold-rim roof and base plinth, gold door and chimney; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/folder-icon-001.png', alt: 'A 3D-rendered open folder icon — bronze body with a black document angled out; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/folder-icon-002.png', alt: 'A 3D-rendered closed folder icon — gold rim with black face; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/folder-icon-003.png', alt: 'A 3D-rendered closed folder icon (alternate angle) — gold rim with black face; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/pen-icon-001.png', alt: 'A 3D-rendered ballpoint pen — black barrel with gold tip and clip, angled diagonally; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/pen-icon-002.png', alt: 'Pen icon variant — vertical orientation, gold details; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/pen-icon-003.png', alt: 'Pen icon variant — opposing diagonal orientation, gold details; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/padlock-icon-001.png', alt: 'A 3D-rendered padlock icon — rounded black body with gold shackle and a gold keyhole; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/padlock-icon-002.png', alt: 'Padlock icon variant — flat-top body with gold rim outline and gold keyhole; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/padlock-icon-003.png', alt: 'Padlock icon variant — angled 3D view, gold rim and gold keyhole; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/dashboard-icon-001.png', alt: 'A 3D-rendered dashboard panel icon: black case with two large bronze content panels and a column of bronze button squares on each side; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/dashboard-icon-002.png', alt: 'Paired dashboard panels — two compact units side by side with bronze content blocks and small button rows; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/dashboard-icon-003.png', alt: 'Paired dashboard panels (tilted variant) — two compact units with bronze content blocks; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/document-icon-001.png', alt: 'Two stacked black document cards with horizontal bronze lines representing text; 3D render, cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/document-icon-002.png', alt: 'Two black document cards with gold rims and gold text-line bars — angled tilted variant; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/calculator-icon-001.png', alt: 'A 3D-rendered calculator icon — gold body, black screen showing "123456", gold + cream button grid; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/calculator-icon-002.png', alt: 'Calculator icon variant — full gold body, black screen, square gold-and-black button grid; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/envelope-icon-001.png', alt: 'A 3D-rendered black envelope icon with a thin gold seal stripe across the centre, angled three-quarter view; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/envelope-icon-002.png', alt: 'Black envelope icon — flat front view with gold trim and seal stripe; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/calendar-icon-001.png', alt: 'A 3D-rendered wall calendar icon — black body with gold binder rings, a grid of bronze date squares; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/calendar-icon-002.png', alt: 'Paired wall calendars — two compact black units with gold rings and bronze date grids; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/rocket-icon-001.png', alt: 'A sleek 3D-rendered rocket icon — matte black body with gold porthole and three gold thrust streaks; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'abstract/rocket-icon-002.png', alt: 'Rocket icon variant — gold-trimmed wings and porthole, three gold thrust streaks; cream backdrop.', ratio: '1:1', license: 'Brand-owned' },
  ...
  { src: 'money/money-bag-001.png', alt: 'Black 3D-rendered money bag tied with a gold cord, large gold dollar sign embossed in the centre, isolated.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'money/money-bag-002.png', alt: 'Black money bag with right-positioned gold dollar sign — variant.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'money/money-bag-003.png', alt: 'Black money bag with left-positioned gold dollar sign — variant.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'money/calculator-with-coins-001.png', alt: 'Black tabletop calculator displaying "123456" surrounded by floating bronze coins with dollar signs — 3D render, isolated.', ratio: '1:1', license: 'Brand-owned' },
  { src: 'money/calculator-with-coins-002.png', alt: 'Gold-trimmed calculator with bronze coins flanking either side — 3D render, isolated on cream.', ratio: '1:1', license: 'Brand-owned' },
